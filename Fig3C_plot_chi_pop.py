...
class S_v_pop():
    ...
    def which_pop(self,resid):
        ...
        if pop[0]>0.5 and pop[2]>0.5*pop[1]:return 1  #pop[2] a significant fraction of pop[1]
...
def load_md():
    ...
    md_no=dict()
    md_corr=dict()
    for file,md in zip(['chi12_populations/chi12_HETs_4pw.txt','chi12_populations/chi12_HETs_MET_4pw.txt'],[md_no,md_corr]):
